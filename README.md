...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-vue/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-vue/actions/workflows/validate.yml)

Neovim tree-sitter queries for **vue**, part of the
...
- [ ] Changes are scoped to `vue` — do not include files for other languages
